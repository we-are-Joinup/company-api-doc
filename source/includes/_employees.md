...
400 | Bad Request There are several cases. Another request was made less than 1 minute ago. Or the request contains more than 50 employees. Or there is some validation error indicated in the response